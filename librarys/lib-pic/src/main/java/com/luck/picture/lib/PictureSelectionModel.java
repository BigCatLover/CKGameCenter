...
public class PictureSelectionModel {
    ...
    /**
     * @param size do not compress when the origin image file size less than one value
     * @return
     */
    public PictureSelectionModel compressMaxKB(int size) {
        selectionConfig.mLeastCompressSize = size;
        return this;
    }
