...
public class RadarChart extends PieRadarChartBase<RadarData> {
    ...
    private int mWebColorInner = Color.rgb(122, 122, 122);//#7a7a7a
    private int mValueColorInner = Color.rgb(122, 122, 122);
    private int mBgColorInner = Color.rgb(242, 242, 242);
...
//        }
    ...
    public void setValueColorInner(int color) {
        mValueColorInner= color;
    }

    public int getBgColorInner() {
        return mBgColorInner;
    }

    public void setBgColorInner(int color) {
        mBgColorInner = color;
    }

    public int getValueColorInner() {
        return mValueColorInner;
    }
