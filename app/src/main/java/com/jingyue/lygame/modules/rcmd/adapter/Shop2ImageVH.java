 ...
 */
public class Shop2ImageVH extends BaseItem.BVH<ShopImageBean> {

    @BindView(R.id.type2_image1)
    ImageView type2Image1;
    @BindView(R.id.type2_image2)
    ImageView type2Image2;

    public Shop2ImageVH(View itemView) {
        super(itemView);
    ...
    public void setValue(final ShopImageBean value) {
        ImageLoader.getInstance().showImage(ImageLoader.getDefaultSourceOptions(type2Image1, value.list.get(0), R.mipmap.ic_load_err_land));
        ImageLoader.getInstance().showImage(ImageLoader.getDefaultSourceOptions(type2Image2, value.list.get(1), R.mipmap.ic_load_err_land));
        type2Image1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BigImageGalleryActivity.open(v.getContext(), value.list.get(0), value.gameId, v, true);
            }
        });
        type2Image2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
