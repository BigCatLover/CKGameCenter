...
//        DEFAULT_BORDER_COLOR = getResources().getColor(R.color.lyg_common_bg);
//        DEFAULT_BORDER_COLOR = Color.TRANSPARENT;
        ...
        mCornerRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_corner_radius, 0);
        icon_left_top = a.getResourceId(R.styleable.CircleImageView_corner_left_top_icon, 0);
        icon_left_bottom = a.getResourceId(R.styleable.CircleImageView_corner_left_bottom_icon, 0);
        icon_right_top = a.getResourceId(R.styleable.CircleImageView_corner_right_top_icon, 0);
        icon_right_bottom = a.getResourceId(R.styleable.CircleImageView_corner_right_bottom_icon, 0);
        a.recycle();
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            ...
            if (drawable instanceof ColorDrawable) {
                ...
                bitmap = Bitmap.createBitmap(drawable.getIntrinsicWidth() <= 0 ? COLORDRAWABLE_DIMENSION : drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight() <= 0 ? COLORDRAWABLE_DIMENSION : drawable.getIntrinsicHeight(), BITMAP_CONFIG);
            }
