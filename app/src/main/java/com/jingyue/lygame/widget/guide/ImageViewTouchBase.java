...
import com.jingyue.lygame.widget.RotateBitmap;

/**
 * Created by zhanglei on 2017/7/21.
 */
...
public class ImageViewTouchBase extends AppCompatImageView {
    ...
    // This function changes bitmap, resetHttpFactory base matrix according to the size
    // of the bitmap, and optionally resetHttpFactory the supplementary matrix
